...
class iNaturalist2018(object):
    def __init__(self, batch_size=32, root="/media/intisar/dataset/visual_categorization/herbarium-2022-fgvc9/", class_balance=False, num_works=12):
        ...
        train_txt="/media/intisar/dataset/visual_categorization/herbarium-2022-fgvc9/train_hbm.txt"
        val_txt="/media/intisar/dataset/visual_categorization/herbarium-2022-fgvc9/val_hbm.txt"
